/**
 * Node Network Background — shared dark backdrop for console pages.
 * ----------------------------------------------------------------------------
 ...
 *
 * Usage:
 *   <script type="module" src="../src/ui/node-network-bg.js"></script>
 *   <script type="module" src="../src/ui/node-network-bg.js" data-accent="#00d4ff"></script>
 *
 * data-accent is optional (defaults to gold). Honors
